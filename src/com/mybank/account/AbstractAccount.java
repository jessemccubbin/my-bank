...
public abstract class AbstractAccount {
	...
	public void checkAmountIsPositiveElseThrow(double amount) throws IllegalArgumentException {
		if (amount <= 0.0) {
	...
	public void checkForSufficientFundsElseThrow(double amount) throws InsufficientFundsException {
		if (amount > this.balance) {
			throw new InsufficientFundsException(
					"Insufficient funds: $" + this.balance + " - cannot transfer " + amount);
		}
	}
	...
	public String toString() {
		...
		return "AbstractAccount [customer=" + customer + ", accountName=" + accountName + ", balance=" + balance + ", accountNumber=" + accountNumber + "]";
